...
describe('http-client-base test', () => {
  ...
  //
  //   const response =
  //     await httpClient.burnServiceToken(SERVICE_TOKEN_CONTRACT_ID, request);
  //
  //   console.log("response: " + JSON.stringify(response))
  //   expect(response["statusCode"]).to.equal(1002);
  // })
  ...
  //     "ownerSecret": OWNER_SECRET,
  //     'toAddress': OWNER_ADDRESS,
  //     // 'toUserId': "Ua469a80840ac51bb68dab4c91bbd7d58",
  //     'name': 'Nnq8Edc',
  //     'meta': '5y4bh'
  //   }
  //
  //   // const request = new NonFungibleTokenMintRequest(
  //   //   OWNER_ADDRESS,
  //   //   OWNER_SECRET,
  //   //   "Nnq8Edce",
  //   //   "",
  //   //   null,
  //   //   "Ua469a80840ac51bb68dab4c91bbd7d58"
  //   // )
  //   const response =
